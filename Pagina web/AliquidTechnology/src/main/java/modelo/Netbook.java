...
@Table(name = "netbook")
@NamedQueries({
    @NamedQuery(name = "Netbook.findAll", query = "SELECT n FROM Netbook n"),
    @NamedQuery(name = "Netbook.findByIndice", query = "SELECT n FROM Netbook n WHERE n.indice = :indice")})
public class Netbook implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Netbook)) {
            return false;
        }
        Netbook other = (Netbook) object;
    ...
    public String toString() {
        return "modelo.Netbook[ indice=" + indice + " ]";
    }
