...
@NamedQueries({
    ...
    @NamedQuery(name = "Notebook.findByIndice", query = "SELECT n FROM Notebook n WHERE n.indice = :indice")})
public class Notebook implements Serializable {
    ...
    public Notebook(Integer indice) {
        this.indice = indice;
    }
    ...
    public String toString() {
        return "modelo.Notebook[ indice=" + indice + " ]";
    }
